  ...
  return (
    <div ref={ref}>
      <img
        ...
        className=" w-full h-[35rem] object-cover  bg-opacity-90"
      />
      <div className="flex flex-col items-center justify-center  text-white absolute inset-0">
        <div className="flex flex-col gap-y-2 md:mb-[40rem] lg:mb-0"><motion.h3
        ...
        >
          <p className="flex flex-row gap-x-1 lg:text-lg ">
            {" "}
            <div className="rounded-full h-2 w-2 bg-white lg:mt-3 sm:mt-2 font-semibold"></div>Front-end
            web developer
          </p>
          <p className="flex flex-row gap-x-1 lg:text-lg">
            {" "}
